...
const ZaionsMobileLinks: React.FC = () => {
  ...
  return (
    <ZaionsIonPage pageTitle='Mobile Link Page'>
      {/* Page Content */}
      <ZIonContent>
        <ZaionsTopMenu />
        <ZaionsInpageHeader
        ...
        <ZaionsTwoByTwoRightCols
          title={
            <ZIonText className='mb-5 ms-4 zaions__fw_800'>
              SMS Messaging
            </ZIonText>
          }
          text={
        ...
        <ZaionsTwoByTwoLeftCols
          title={
            <ZIonText className='mb-5 ms-5 zaions__fw_800'>
              Deep Links <br />
            </ZIonText>
          }
          text={
        ...
        <ZaionsTwoByTwoRightCols
          title={
            <ZIonText className='mb-5 ms-4 zaions__fw_800'>QR Codes</ZIonText>
          }
          text={
            <ZIonText className='ms-4'>
