      ...
      <ZIonContent>
        ...
        <ZIonGrid className='zaions__bg_gray'>
          <ZIonRow className='my-5 pt-5 pb-3'>
            ...
            >
              <ZIonText className='fw-bold'>Careers</ZIonText>
              <ZIonText>
                <h1 className='zaions__page_title'>Join our team</h1>
              </ZIonText>
              <ZIonText className='fs-4 zaions__color_gray2'>
        ...
        <ZIonGrid>
          <ZIonRow>
            ...
            >
              <ZIonText>
                <h2 className='zaions__fw_800'>Open Positions</h2>
              </ZIonText>
              <div className=''>
                <button
          ...
          <ZIonRow>
            ...
            >
              {OurJobsData.map((el) => {
                return (
                  <div key={el.id}>
                    <ZIonRow className='mt-5' key={el.id}>
                      <ZIonCol
                        className={classNames({
                          'mt-5 pt-4': true,
                          'ion-text-center mb-2': !isMdScale,
                          'd-flex ion-align-items-center ion-justify-content-between':
                            isMdScale,
                        })}
                      >
                        <div className=''>
                          <ZIonText>
                            <h2 className='zaions__fw_750 zaions__color_dark_2'>
                              {el.JobTitle}
                            </h2>
                          </ZIonText>
        ...
        >
          ...
          <ZIonRow className='mb-4'>
            ...
            >
              ...
              <ZIonText className='fs-5 zaions__color_gray2 pb-5'>
              ...
              >
                <Masonry gutter='10px'>
                  {OurGalleryData.map((el) => (
                    <div className={`${classes.zaions__gallery}`} key={el.id}>
                      <ZIonImg
                        src={el.image}
