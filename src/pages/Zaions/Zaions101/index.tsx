...
const Zaions101: React.FC = () => {
  ...
  return (
    <ZaionsIonPage pageTitle='101 Page'>
      {/* Page Content */}
      <ZIonContent fullscreen>
        ...
        <ZaionsTwoByTwoLeftCols
          ...
          text={`Make your links powerful marketing assets. Custom links replace
					“${PRODUCT_DOMAIN}” with your chosen domain name, making your links
