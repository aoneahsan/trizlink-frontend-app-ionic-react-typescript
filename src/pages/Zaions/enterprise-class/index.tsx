              ...
              <ZIonGrid>
                <ZIonRow>
                  ...
                  <ZaionsInpageCol
                    ...
                    text={
                      'We set the bar more than a decade ago when it comes to link management security. Today, our 24 hour on-call teams continue to monitor the availability and performance of your links all day, every day. And of course our platform is fully GDPR compliant and CCPA ready.'
                    }
                    className='pt-4 mt-5'
                  />
