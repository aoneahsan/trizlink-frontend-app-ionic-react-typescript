        ...
        <ZIonGrid>
          <ZIonRow>
            ...
            <ZIonCol
              ...
              sizeSm='12'
              sizeXs='12'>
              <ZIonText className='font-bold'></ZIonText>
              <ZIonText>
                <h1
                ...
                <ZIonGrid>
                  <ZIonRow>
                    ...
                    <ZIonCol
                      size='11'
                      sizeXs='10'>
                      <span className='text-lg zaions__color_gray2'>
        ...
        <ZIonGrid>
          <ZIonRow>
            ...
            <ZIonCol
              ...
              sizeSm='12'
              sizeXs='12'>
              <ZIonText className='font-bold'>Manage Links & Pages</ZIonText>
              <ZIonText>
                <h1
                  className={`zaions__page_title text-3xl ${
                    !isXlScale ? 'text-5xl' : ''
        ...
        <ZIonGrid>
          <ZIonRow>
            ...
            <ZIonCol
              ...
              sizeSm='12'
              sizeXs='12'>
              <ZIonText className='font-bold'>Campaign Management</ZIonText>
              <ZIonText>
                <h1
                  className={`zaions__page_title text-3xl ${
                    !isXlScale ? 'text-5xl' : ''
        ...
        <ZIonGrid>
          <ZIonRow>
            ...
            <ZIonCol
              ...
              sizeSm='12'
              sizeXs='12'>
              <ZIonText className='font-bold'>Link Management</ZIonText>
              <ZIonText>
                <h1
                  className={`zaions__page_title text-3xl ${
                    !isXlScale ? 'text-5xl' : ''
