...
const ZaionsCodeOfConduct: React.FC = () => {
  return (
    <ZIonPage pageTitle='Code Of Conduct Page'>
      {/* Content */}
      <ZIonContent>
        <ZaionsTopMenu />
        <ZIonGrid className='my-5'>
          <ZIonRow>
            ...
            <ZIonCol
              ...
              <ZIonText>
                <h4 className='mt-3 text-lg font-bold'>Introduction</h4>
              </ZIonText>
              ...
              <ZIonText>
                <h4 className='mt-4 text-lg font-bold'>Compliance with Laws</h4>
              </ZIonText>
              ...
              <ZIonText>
                <h4 className='mt-4 text-lg font-bold'>Data Security</h4>
              </ZIonText>
              <ZIonText className='zaions__color_gray2'>
              ...
              <ZIonText>
                <h4 className='mt-4 text-lg font-bold'>Health and Safety</h4>
              </ZIonText>
              <ZIonText className='zaions__color_gray2'>
