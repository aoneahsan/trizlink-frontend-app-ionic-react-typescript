        ...
        <ZIonGrid className='my-5'>
          <ZIonRow className='ion-justify-content-center'>
            ...
            >
              ...
              <ZIonTitle className='ion-no-padding mb-2 fw-bold'>
                Interpretation
              </ZIonTitle>
              <ZIonText>
              ...
              <ZIonTitle className='ion-no-padding mb-2 mt-3 fw-bold'>
                Definitions
              </ZIonTitle>
              ...
              <ZIonList lines='none'>
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Account</ZIonText> means a
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Affiliate</ZIonText> means an
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Application</ZIonText> refers
                    to ZLink, the software program provided by the Company.
                  </ZIonText>
                </ZIonItem>
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Company</ZIonText> (referred
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Country</ZIonText> refers to:
                    Pakistan
                  </ZIonText>
                </ZIonItem>
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Device</ZIonText> means any
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Personal Data</ZIonText> is
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Service</ZIonText> refers to
                    the Application.
                  </ZIonText>
                </ZIonItem>
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Service Provider</ZIonText>{' '}
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>Usage Data</ZIonText> refers
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>You</ZIonText> means the
              ...
              <ZIonTitle className='ion-no-padding fw-bold mb-2'>
              ...
              <ZIonTitle className='ion-no-padding fw-bold mb-2 mt-3'>
              ...
              <ZIonList lines='none'>
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>To contact You:</ZIonText> To
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>To provide You</ZIonText> with
                ...
                <ZIonItem>
                  <ZIonText>
                    <ZIonText className='fw-bold'>For other purposes</ZIonText>:
              ...
              <ZIonList lines='none'>
                ...
                <ZIonItem>
                  <ZIonText className='fw-bold'>With Affiliates:</ZIonText> We
                ...
                <ZIonItem>
                  <ZIonText className='fw-bold'>With other users:</ZIonText>{' '}
                ...
                <ZIonItem>
                  <ZIonText className='fw-bold'>With Your consent</ZIonText>: We
              ...
              <ZIonTitle className='ion-no-padding mb-2 mt-3'>
                <h5 className='ion-no-margin fw-bold'>Business Transactions</h5>
              </ZIonTitle>
              <ZIonText>
              ...
              <ZIonTitle className='ion-no-padding mb-2 mt-3'>
                <h5 className='ion-no-margin fw-bold'>Law enforcement</h5>
              </ZIonTitle>
              <ZIonText>
              ...
              <ZIonTitle className='ion-no-padding mb-2 mt-3'>
                <h5 className='ion-no-margin fw-bold'>
