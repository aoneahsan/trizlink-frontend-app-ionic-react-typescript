...
import { type UserAccountEmailType } from '@/types/UserAccount/index.type';
...
const ZAccountDetails: React.FC = () => {
  ...
  const setPrimaryEmail = (id: string): void => {
    setUserAccountEmials(oldEmails => {
      return (
        oldEmails?.map(email =>
          email.id === id
