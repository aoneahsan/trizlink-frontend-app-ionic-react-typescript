            ...
            <ZIonCol size='7'>
              ...
              <ZIonAccordionGroup>
                ...
                >
                  ...
                  >
                    <ZIonLabel className='d-flex ion-align-items-center'>
                      <ZIonText className='fw-bold zaions__fs_15'>
                        Analytics
                      </ZIonText>
                      <ZIonIcon
                        className='ps-3 fs-5'
              ...
              <ZIonRow className='ion-justify-content-center mt-4'>
                ...
                <ZIonCol size='10.5'>
                  <ZIonButton
                    expand='block'
                    shape='round'
                    className='ion-text-capitalize fw-bold zaions__fs_16'
                    style={{
                      '--padding-top': '1.4rem',
                ...
                <ZIonCol size='10.5' className='mt-4'>
                  ...
                  >
                    <ZIonIcon
                      ...
                      className='me-1'
                    />
                    <ZIonText color='dark' className='fw-bold'>
                      Header
                    </ZIonText>
                  </ZIonButton>
                </ZIonCol>
                        ...
                        <ZIonRow className='pt-3 pb-1'>
                          ...
                          >
                            ...
                            <div className=''>
                              ...
                              >
                                <ZIonText className='me-2 fw-bold zaions__fs_14 letter-spacing-0px'>
                                  Seo Home - Zaions
                                </ZIonText>
                            ...
                            <div className=''>
                              ...
                              >
                                <ZIonText className='me-2 fw-bold zaions__fs_13 letter-spacing-0px'>
                          ...
                          <ZIonCol size='12' className='ps-0 d-flex'>
                            <div>
                              <ZIonButton
                                fill='clear'
                              ...
                              >
                                ...
                                <ZIonText
                                  className='ms-1 mt-1 ps-1 fw-bold'
                                  color='medium'
                                >
                                  0 clicks
                                </ZIonText>
