  ...
  return (
    <ZIonRow className='border zaions__bg_white mt-4'>
      <ZIonCol size='12' className='ion-padding-vertical border-bottom'>
        <ZIonText color='dark'>
          <h5 className='fw-bold ion-no-margin py-1 ps-4'>{bannerTitle}</h5>
        </ZIonText>
      </ZIonCol>
      {!tableData?.length && (
        <ZIonCol className='my-5 py-5 d-flex flex-column ion-justify-content-center ion-align-items-center'>
          <ZIonImg
            src={imageUrl}
            className='mb-5 mt-4'
