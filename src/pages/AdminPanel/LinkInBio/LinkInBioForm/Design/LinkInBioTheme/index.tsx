  ...
  return (
    <>
      ...
      >
        ...
        <div className='d-flex ion-align-items-center ion-padding-bottom border-bottom__violet'>
        ...
        {/* 🎫 Button type */}
        <ZIonTitle className='fw-bold zaions__fs_16 ion-margin-top ion-no-padding z_ff__b612'>
          🎫 Button type
        </ZIonTitle>
        <ZIonRow
          className={classNames(classes['row-gap-1-point-6-rem'], {
      ...
      >
        ...
        <div className='d-flex ion-align-items-center ion-padding-bottom'>
          <ZaionsRSelect
            ...
            className='zaions__w100 z_ff__roboto'
            name='theme.font'
            onChange={(_value) => {
              setFieldValue(
                'theme.font',
      ...
      >
        <ZIonRow>
          ...
          <ZIonCol className='d-flex ion-justify-content-end'>
            <ZRCSwitch
              onChange={(value) => {
        ...
        {values?.theme?.background?.enableBgImage && (
          <div className='d-flex ion-align-items-center ion-padding-bottom mt-4'>
            <ZDragAndDrop
