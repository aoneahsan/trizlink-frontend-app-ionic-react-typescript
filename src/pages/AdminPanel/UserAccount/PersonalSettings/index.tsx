        ...
        return (
          <ZIonRow
            ...
            <ZIonCol
              ...
              sizeXs='12'
              className={classNames({
                'flex ion-align-items-center ion-justify-content-between': true,
                'mb-2': !isSmScale
              })}>
              <div className=''>
                <ZIonTitle
                    ...
                    <div className='mt-2'>
                      ...
                      <ZIonItem
                        ...
                        testingselector={
                          CONSTANTS.testingSelectors.userAccount
                            .notificationSettingsTab
                            .browserNotificationAccordion.chromeNotificationItem
                        }
                        className={classNames({
                      ...
                      <div className=''>
                        ...
                        <ZIonItem
                          ...
                          <ZIonText slot='end'>
                            <ZRCSwitch
                              checked={values?.browser?.playSoundInNotification}
                              onChange={checked => {
                                void setFieldValue(
                      ...
                      <div className=''>
                        ...
                        <ZIonItem
                          ...
                          <ZIonText
                            ...
                            <ZRCSwitch
                              checked={
                                values?.email?.notifications?.otherNotifications
                              }
                              onChange={checked => {
                                void setFieldValue(
