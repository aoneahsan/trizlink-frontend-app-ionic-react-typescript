...
const ZaionsRoutes = {
	...
	AdminPanel: {
		...
		Projects: {
			Main: '/projects',
			Create: '/projects/new',
			Roadmap: `/projects/${CONSTANTS.RouteParams.project.projectId}/boards/${CONSTANTS.RouteParams.project.board.boardId}/roadmap`,
			Edit: `/projects/${CONSTANTS.RouteParams.project.projectId}/edit`,
			...
			Board: {
				...
				Edit: `/projects/${CONSTANTS.RouteParams.project.projectId}/edit/board/${CONSTANTS.RouteParams.project.board.boardId}`,
			},
