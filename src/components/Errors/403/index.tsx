    ...
    <ZIonContent>
      ...
      <ZIonRow className='w-full h-full ion-justify-content-center'>
        <div
          ...
          <ZIonText className='mt-2 md:text-5xl'>Access Forbidden</ZIonText>
          <ZIonText className='mt-3 md:text-lg ion-text-center'>
            Sorry, but you don&apos;t have the necessary permissions to access
            this resource. If you believe this is a mistake or need further
