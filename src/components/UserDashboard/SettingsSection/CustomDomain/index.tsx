  ...
  return (
    <>
      ...
      <ZIonRow className='mx-4 mt-5'>
        ...
        >
          <ZIonText className='p-0 mb-2 fw-bold'>
            How add your domain name?
          </ZIonText>
          <ZIonText className='d-block mt-2' color={'medium'}>
        ...
        >
          <div className='py-4 px-4 zaions__bg_white rounded'>
            ...
            <div className='d-flex ion-align-items-center mb-3'>
              <ZIonItem slot='start' className='zaions__w88 me-auto'>
                <ZIonLabel position='floating'>link.yourbrand.com</ZIonLabel>
                <ZIonInput></ZIonInput>
