  ...
  return (
    <>
      <ZIonCol
        ...
        sizeSm='3.3'
        sizeXs='3.3'
        className='border-end ion-md-d-none'
      >
        <ZIonText className='fw-bold ps-2'>Your settings</ZIonText>
        <ZIonList lines='none'>
          {/* Profile */}
          <ZIonItem
        ...
        {/* Account Settings */}
        <ZIonText className='fw-bold ps-2'>Account settings</ZIonText>
        ...
        {/* Developer Settings */}
        <ZIonText className='fw-bold ps-2'>Developer settings</ZIonText>
        <ZIonList lines='none'>
          {/* API */}
          <ZIonItem
            className='ion-no-padding ion-no-margin mb-1'
