  ...
  return (
    ...
    >
      ...
      >
        <ZIonCol
          className={classNames({
            'd-flex ion-align-items-center ion-text-center': true,
            'ps-3 ms-1': isLgScale,
          })}
          sizeXl='8'
          sizeLg='7'
          ...
          >
            <ZIonButton
              className={classNames(
                ...
                {
                  'ion-text-capitalize mx-2 mb-3 fw-bolder': true,
                }
              )}
              size='small'
              fill='clear'
        ...
        >
          ...
          >
            ...
            <ZIonText>
              <h6 className='ion-no-margin fw-bold'>Upgrade</h6>
            </ZIonText>
          </ZIonButton>
          <ZIonButton
            className='ion-text-capitalize me-2'
          ...
          >
            ...
            />{' '}
            <ZIonText color='dark'>
              <h6 className='ion-no-margin fw-bold'>Share</h6>
            </ZIonText>
          </ZIonButton>
          {isLgScale && (
            <ZIonButton
