...
const PAPixelBlock: React.FC<PAPixelBlockI> = () => {
  ...
  return (
    <div className='h-full overflow-hidden border rounded-lg shadow-md zaions__light_bg'>
      <div
        ...
        <ZIonText className='text-lg'>🎯 Retargeting Pixels</ZIonText>
      </div>
      ...
      <div className='flex flex-col gap-3 ion-padding ion-align-items-center ion-justify-content-center'>
        ...
        <div className='flex flex-col mt-3 ion-text-center'>
          <ZIonText className='text-lg'>
            Want to add Retargeting pixels?
          </ZIonText>
          <ZIonText
            className='mt-2'
            color='medium'>
            You can add Retargeting Pixels on the link edition.
          </ZIonText>
        </div>
      </div>
    </div>
