...
import { checkmark, gridOutline } from 'ionicons/icons';
              ...
              <ZIonRow className='mt-2'>
                ...
                <ZIonCol
                  ...
                  <div className='relative h-full'>
                    ...
                    <div className='h-full px-2 py-1 overflow-y-scroll zaions_pretty_scrollbar'>
                      {/* Single comment */}
                      {[1].map(el => (
                      ...
                      {/* Comment box */}
                      <ZWorkspaceCommentBox className='sticky bottom-0 px-2 py-2 mt-2 border-t rounded' />
                    </div>
                  </div>
                </ZIonCol>
              </ZIonRow>
