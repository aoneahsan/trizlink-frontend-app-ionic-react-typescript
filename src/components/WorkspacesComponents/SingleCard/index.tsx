 ...
 * */
import { type WorkspacePageCardInfoPopoverItemType } from '@/types/AdminPanel/workspace';
...
export const SingleCard: React.FC<{
  ...
  return (
    <ZIonCard
      ...
      <ZIonCardContent className='relative flex flex-col h-full py-3 ion-text-center ion-justify-content-center ion-align-items-center'>
        {/*  */}
        {showInfoIcon && (
          <div
            className='absolute flex w-full cursor-pointer top-1 start-0 ps-2'
