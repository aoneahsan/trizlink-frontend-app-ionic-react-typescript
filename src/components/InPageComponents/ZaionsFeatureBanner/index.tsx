      ...
      <ZIonGrid className={classValue}>
        ...
        <ZIonRow>
          <ZIonCol
            ...
            sizeXs='0'
          ></ZIonCol>
          <ZIonCol sizeXl='10' sizeLg='11' sizeMd='11' sizeSm='12' sizeXs='12'>
            <ZIonRow
              className={`${
                rowShadow === true ? classes.row__box_shadow : ''
              } p-0`}
            >
              <ZIonCol
                sizeXl=''
              ...
              <ZIonCol
                ...
                className={`${
                  textCenter === true
                    ? 'd-flex justify-content-center ion-align-items-center'
                    : 'ms-5'
                }`}
              >
                <div className=''>
                  <span className='zaions__color_gray2 fs-5 mb-1'>
                    {bannerLabel}
                  </span>
                  <ZIonRouterLink routerLink={routeLink} color={'dark'}>
                    <h2 className='' style={{ fontWeight: '800' }}>
                      {bannerColTitle}
                    </h2>
                  </ZIonRouterLink>
                  <ZIonText className='fs-6 zaions__color_gray2'>
                    {bannerText}
                  </ZIonText>
                  <ZIonRouterLink
                    routerLink={
