        ...
        <>
          ...
          <ZIonContent className='ion-padding'>
            ...
            <Form onSubmit={handleSubmit} className='px-4'>
              ...
              >
                <ZIonLabel position='stacked'>Select the platform*</ZIonLabel>
                <ZIonSelect
                  name='platform'
              ...
              >
                <ZIonLabel position='floating'>Name You pixel*</ZIonLabel>
                <ZIonInput
                  type='text'
              ...
              >
                <ZIonLabel position='floating'>Pixel ID*</ZIonLabel>
                <ZIonInput
                  type='text'
