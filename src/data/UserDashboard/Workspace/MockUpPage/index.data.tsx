...
export const PlatformColorsData: Array<{
  colorName?: string;
  colorCode?: string;
}> = [
  {
...
export const PlatformIconsData: {
  defaultIcons: Array<{ id: string; icon: string; iconName?: string }>;
  platformIcons: Array<{ id: string; icon: string; iconName?: string }>;
} = {
  defaultIcons: [
...
export const ContentStyleData: Array<{
