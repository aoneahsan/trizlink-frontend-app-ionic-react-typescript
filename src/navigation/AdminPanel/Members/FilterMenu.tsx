...
const ZMembersFilterMenu: React.FC = () => {
  ...
  const [compState, setCompState] = useState<{
    ...
    columnOrderIds: [],
    membersColumn: MemberTableColumns
  });
  // #endregion
  ...
  const setMembersFilterOptions = useSetRecoilState(
  ...
  const handleCarouselCardReorder = (
    ...
    setCompState(oldValues => ({
      ...
      columnOrderIds: membersColumnIds
    }));
  };
        ...
        <ZIonContent className='ion-padding-top'>
          <Formik
            ...
            onSubmit={async values => {
              try {
                setMembersFilterOptions(oldValues => ({
                  ...oldValues,
                  timeFilter: {
                  ...
                  role: values.filters.role as WSRolesNameEnum,
                  status: values.filters.status as ZTeamMemberInvitationEnum
                }));

                const zStringifyData = zStringify({
                  type: ZUserSettingTypeEnum.membersListPageTable,
                  settings: zStringify({
                    ...
                    <div className='px-3'>
                      ...
                      <ZaionsRSelect
                        ...
                        value={CONSTANTS?.ZRolesOptions?.find(
                          el => el.value === values.filters.role
                        )}
                        options={[
                          {
                            label: 'Select role...',
                      ...
                      <ZaionsRSelect
                        ...
                        value={CONSTANTS?.ZStatesOptions?.find(
                          el => el.value === values.filters.status
                        )}
                        options={[
                          {
                            label: 'Select status...',
...
export default ZMembersFilterMenu;
